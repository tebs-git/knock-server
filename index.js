...
// Visitor knocks - DATA-ONLY MESSAGE (ensures onMessageReceived is called)
app.post("/knock", async (req, res) => {
  try {
    ...
    const message = {
      token: doorToken,
      // ✅ DATA-ONLY - This ensures onMessageReceived is ALWAYS called
      data: {
        title: "Knock Knock!",
    ...
    console.log("📤 Sending DATA-ONLY message to FCM...");
